              ...
              <div className="row">
                <div className="col" style={{ marginBottom: "10px" }}>
                  ...
                  >
                    ...
                    <div style={{ position: "relative" }}>
                      <img
                        src="https://dw4gwhhv7uqc1.cloudfront.net/catalog%2FSeller_39401%2F66fd3a1b0ff02.jpg"
                        alt="Product"
                    ...
                    <div style={{ padding: "16px" }}>
                      ...
                      >
                        adidas Samba OG Cloud Sneakers
                      </h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="col" style={{ marginBottom: "10px" }}>
                  ...
                  >
                    ...
                    <div style={{ padding: "16px" }}>
                      ...
                      >
                        Beverly Hills Polo Club Multi-Function Watch
                      </h3>
                    </div>
                  </div>
                </div>
                <div className="col" style={{ marginBottom: "10px" }}>
                  ...
                  >
                    ...
                    <div style={{ position: "relative" }}>
                      <img
                        src="https://dw4gwhhv7uqc1.cloudfront.net/catalog%2FSeller_39401%2F66ea9ee3947e3.jpg"
                        alt="Product"
                        style={{ width: "100%", display: "block" }}
                      />
                      {/* Sale Badge */}
